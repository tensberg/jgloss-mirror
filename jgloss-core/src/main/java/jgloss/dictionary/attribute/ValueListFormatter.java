...
public interface ValueListFormatter {
     ...
     *        {@link AttributeValueFormatter#format(Attribute,AttributeValue,StringBuilder) format} 
     ...
     */
    StringBuilder format( AttributeValueFormatter valueFormatter, Attribute<?> att, List<? extends AttributeValue> val,
                         StringBuilder buf);
