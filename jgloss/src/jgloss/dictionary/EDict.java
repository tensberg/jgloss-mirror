...
public class EDict extends FileBasedDictionary {
    ...
    public EDict( File dicfile) throws IOException, IndexCreationException {
        this( dicfile, true);
    }

    public EDict( File dicfile, boolean createindex) throws IOException, IndexCreationException {
