...
public class HTMLAnnotator {
    ...
    /**
     * Test if a tag contains an URL attribute and replaces it with an URL generated by the
     * URLRewriter. Currently supported are the <CODE>href</CODE> attribute of <CODE>a</CODE>
     * and <CODE>area</CODE>, the <CODE>src</CODE> attribute of <CODE>img</CODE> and the
     * <CODE>action</CODE> attribute of <CODE>form</CODE>.
     *
